                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
                    <div className="group bg-white border border-border border-gray-200 rounded-xl p-6 shadow-card hover:shadow-lg transition-all duration-300 animate-fade-in text-center" style={{ animationDelay: "0s" }}>
                        <div className="mb-4 overflow-hidden rounded-lg">
                            <img src="/how-it-works-1.jpg" alt="Click the Button" className="w-full h-32 object-cover group-hover:scale-105 transition-transform duration-300" />
                        </div>
                        <div className="inline-flex items-center justify-center w-12 h-12 rounded-full bg-brand-900 text-white mb-4 text-lg font-bold">1</div>
                    ...
                    <div className="group bg-white border border-border border-gray-200 rounded-xl p-6 shadow-card hover:shadow-lg transition-all duration-300 animate-fade-in text-center" style={{ animationDelay: "0.1s" }}>
                        <div className="mb-4 overflow-hidden rounded-lg">
                            <img src="/how-it-works-2.jpg" alt="We Collect Details" className="w-full h-32 object-cover group-hover:scale-105 transition-transform duration-300" />
                        </div>
                        <div className="inline-flex items-center justify-center w-12 h-12 rounded-full bg-brand-900 text-white mb-4 text-lg font-bold">2</div>
                    ...
                    <div className="group bg-white border border-border border-gray-200 rounded-xl p-6 shadow-card hover:shadow-lg transition-all duration-300 animate-fade-in text-center" style={{ animationDelay: "0.2s" }}>
                        <div className="mb-4 overflow-hidden rounded-lg">
                            <img src="/how-it-works-3.jpg" alt="Get Shareable Link" className="w-full h-32 object-cover group-hover:scale-105 transition-transform duration-300" />
                        </div>
                        <div className="inline-flex items-center justify-center w-12 h-12 rounded-full bg-brand-900 text-white mb-4 text-lg font-bold">3</div>
                    ...
                    <div className="group bg-white border border-border border-gray-200 rounded-xl p-6 shadow-card hover:shadow-lg transition-all duration-300 animate-fade-in text-center" style={{ animationDelay: "0.3s" }}>
                        <div className="mb-4 overflow-hidden rounded-lg">
                            <img src="/how-it-works-1.jpg" alt="Faster Debugging" className="w-full h-32 object-cover group-hover:scale-105 transition-transform duration-300" />
                        </div>
                        <div className="inline-flex items-center justify-center w-12 h-12 rounded-full bg-brand-900 text-white mb-4 text-lg font-bold">4</div>
